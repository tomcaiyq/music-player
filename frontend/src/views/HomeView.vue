        ...
        <div class="list-panel">
          ...
          <div class="song-table" v-loading="loading" element-loading-text="加载中...">
            ...
            >
              ...
              <div class="col-artist">{{ song.artist || '未知歌手' }}</div>
              ...
              <div class="col-actions">
                ...
                <el-button text size="small" @click.stop="deleteSong(song.id)" class="action-btn del-btn">
...
@media (max-width: 768px) { .home-view { padding: 12px; } .col-album { display: none; } }
</style>
